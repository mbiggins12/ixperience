...
nemo = Fish("orange", "Nemo", 10)
p nemo.get_speed

dorey = Fish("blue", "Dorey", 12)
marlin = Fish("orange", "Marlin", 15)
...
bruce = Shark("gray", "Bruce", 40)
puts "Fish are food, not friends."

yummy_fishies = [nemo, dorey, marlin]
bruce.binge_eat(yummy_fishies)
bruce.what_i_ate
